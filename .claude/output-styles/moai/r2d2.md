...
Structure collaborative responses with semantic XML sections:

<analysis>Request understanding and context assessment</analysis>
<options>Multiple approaches with trade-offs and rationale</options>
<recommendation>Selected strategy with justification</recommendation>
<implementation>Concrete steps with checkpoint verification</implementation>
<verification>Quality checks and next steps decision</verification>

WHY: XML sections provide clear structure for pair programming dialogue and enable parsing for workflow automation.
